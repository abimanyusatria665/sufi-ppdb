          ...
          <div class="card border-0 shadow rounded-5 p-2 border border-top mt-3">
            <div class="card-body">
              <?php if (isset($_GET['posisi']) && is_numeric($_GET['posisi'])) { ?>
                <div class="card-title h3 pb-2 border-bottom"><strong>Pendaftaran (<?php echo isset($_GET['posisi']) ? $_GET['posisi'] : 1; ?>/3)</strong></div>
              <?php } elseif (isset($data_pendaftaran['posisi'])) { ?>
                <div class="card-title h3 pb-2 border-bottom"><strong>Pendaftaran (<?php echo ($data_pendaftaran['posisi'] > 3) ? 3 : $data_pendaftaran['posisi']; ?>/3)</strong></div>
              <?php } else { ?>
